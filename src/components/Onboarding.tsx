...
const ONBOARDING_STEPS = [
  {
    ...
    description: 'The emotional thermometer of the world. Share how you feel with one tap and see how the planet feels.',
    highlight: 'One emoji. Millions connected.',
    type: 'info' as const,
  },
  {
    emoji: '⏰',
    title: '3 Windows, 3 Chances',
    description: 'Morning, afternoon, and night - each window captures a moment in time. Pulse at least once a day to keep your streak.',
    highlight: '🌅 6-12h • ☀️ 12-18h • 🌙 18-24h',
    type: 'info' as const,
  },
  {
    emoji: '🔥',
    title: 'Streaks & Auras',
    description: 'Build your streak by pulsing daily. Unlock auras that show your commitment: Fire at 7 days, Lightning at 30, Diamond at 100.',
    highlight: '💎 Diamond is PERMANENT',
    type: 'info' as const,
  },
  {
    emoji: '👥',
    title: 'Connect with Friends',
    description: 'Follow friends to see their vibes. When you both follow each other, you start a shared streak - don\'t let your friend down!',
    highlight: '🤝 Snapchat-style friend streaks',
    type: 'info' as const,
  },
  {
    emoji: '🎁',
    title: 'Surprises Await',
    description: 'Every pulse has a 5% chance of a Lucky Drop: shields to protect your streak, special emojis, and more. Plus 12 secret achievements to discover!',
    highlight: '🛡️ Shields • ✨ Special Emojis • 🔓 Secrets',
    type: 'info' as const,
  },
  {
    emoji: '📍',
    title: 'Where are you?',
    description: 'Select your city to see local mood data and compete in city leaderboards. This is optional and can be changed later.',
